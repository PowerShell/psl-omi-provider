...
releaseversion="6.0.0-alpha.13"
centosreleaseversion="6.0.0_alpha.13"
get_url() {
    ...
    linux*)
        ...
        case "$ID" in
            ...
            ubuntu)
                ...
                case "$VERSION_ID" in
                    14.04)
                        package=powershell_$releaseversion-1ubuntu1.14.04.1_amd64.deb
                        ;;
                    16.04)
                        package=powershell_$releaseversion-1ubuntu1.16.04.1_amd64.deb
                        ;;
                    *)
...
echo "downloading: "$(get_url "$package")
